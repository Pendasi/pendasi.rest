...
class CacheManager {
    ...
    private function getFile(string $key, $default = null) {
        ...
        // Sécurité: désérialisation sans classes (réduit le risque d'object injection)
        $value = @unserialize($stored, ['allowed_classes' => false]);

        // Si la valeur était exactement boolean false, unserialize renvoie false aussi: on distingue via la chaîne.
